...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2024 at 07:09 PM
...
INSERT INTO `pembeli` (`pembeli_id`, `nama`, `jenis_kelamin`, `alamat`, `tanggal_beli`) VALUES
(1, 'Agnes Maria A. Salenda', 'perempuan', 'Maguwoharo, Sleman, DI Yogyakarta', '2024-06-27'),
(2, 'Lutfiana Deka Nurhayati', 'perempuan', 'Omah e dewe, Gunungkidul', '2024-07-02'),
(3, 'Luthfiyyah Nur Nafiah', 'perempuan', 'kotagede', '2024-07-03'),
(4, 'Esti Dwi Puspitasari', 'perempuan', 'Piyungan, Bantul', '2024-07-02'),
(5, 'Elsabrina Putri Dinanti', 'perempuan', 'Ngawi', '2024-06-30');
...
INSERT INTO `review` (`review_id`, `isi`, `user_id`) VALUES
(1, 'Aku suka banget sama pie pisangnya chruncy dan tidak terlalu manis dan ngga bikin eneg. Pokoknya mantul, ngga nyesel beli disini...', 3),
(2, 'Wowwww ini luar biasa! Rasanya manis dan teksturnya sangat lembut. Sangat cocok untuk sarapan atau sebagai camilan sehat. Akan beli lagi!', 2),
(3, 'Ngga nyesel beli disini, pacar aku seneng banget sama kue-kuenya, apa lagi nugget pisang dan roti pisangnya... rotinya lembut banget... mantul', 5),
(4, 'Banana Chipsnya enak banget, tekstur nya renyah manisnya juga pas, next bakalan order lagi sih pasti.. pokoknya recomended deh', 4),
(5, 'Gilak sih, ini rasanya enak banget, apa lagi banana cheese pai  nya, rasanya manis biarpun rasa kejunya lumayan strong tapi rasa pisang nya masih tetap kerasa, bakalan langganan deh', 1);
